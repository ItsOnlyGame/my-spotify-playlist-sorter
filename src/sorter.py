...
def fix_track_release_dates(playlist_tracks):
    """
...
def sort_tracks_into_keys(playlist_tracks):
    """
    ...
    for item in playlist_tracks:
        ...
        if artist_key is None:
            ...
            error_message += f"Track that caused the issue: {item['track']['uri']}\n"
...
def commit_sort(spotify, playlist_url, playlist_items, sorted_playlist_items):
    ...
    for j, sorted_item in enumerate(sorted_playlist_items):
        for i, playlist_item in enumerate(playlist_items):
            if playlist_item['track']['uri'] == sorted_item['track']['uri']:
                if snapshot is None:
